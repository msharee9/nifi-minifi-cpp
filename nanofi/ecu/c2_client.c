 ...
 */
void print_usage() {
    printf("usage: ./c2_client <c2 config_file> <c2operation [START | STOP | UPDATE | RESTART]> <c2agent uuid> <ecu uuid> <input_params_file> <output_params_file>\n");
}
...
int main(int argc, char ** argv) {
    ...
    c2context_t * c2 = create_c2_agent(config);
    ...
    char * payload;
    size_t length;
    c2_payload_map_t * c2_payload = c2_payload_server_response(resp_list);
